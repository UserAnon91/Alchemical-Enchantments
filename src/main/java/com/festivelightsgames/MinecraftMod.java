...
public class MinecraftMod implements ModInitializer {
    ...
    static {
        //Enchantment Dusts
        Registry.register(Registry.ITEM, new Identifier("minecraftmod", "dust_amodus"), Dust_Amodus);
        Registry.register(Registry.ITEM, new Identifier("minecraftmod", "dust_lieval"), Dust_Lieval);
        Registry.register(Registry.ITEM, new Identifier("minecraftmod", "dust_lipidius"), Dust_Lipidius);
        Registry.register(Registry.ITEM, new Identifier("minecraftmod", "dust_tridiur"), Dust_Tridiur);
        Registry.register(Registry.ITEM, new Identifier("minecraftmod", "dust_vantium"), Dust_Vantium);
        Registry.register(Registry.ITEM, new Identifier("minecraftmod", "dust_waumuless"), Dust_Waumuless);
        //End Enchantment Dusts


        Registry.register(Registry.BLOCK, new Identifier("minecraftmod", "enchantmentroller"), EnchantmentRoller);
        Registry.register(Registry.ITEM, new Identifier("minecraftmod", "enchantmentroller"),
                new BlockItem(EnchantmentRoller, new FabricItemSettings().group(ItemGroup.MISC)));


        ServerPlayNetworking.registerGlobalReceiver(new Identifier("minecraftmod", "push_enchantment_button"),
		...
		ENCHANTMENT_ROLLER_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE,
                "minecraftmod:enchantment_roller_entity",
                FabricBlockEntityTypeBuilder.create(EnchantmentRollerEntity::new, EnchantmentRoller).build(null));
        ENCHANTMENT_SCREEN_HANDLER = ScreenHandlerRegistry.registerSimple(new Identifier("minecraftmod", "enchantmentroller"), EnchantmentRollerScreenHandler::new);
    }
